...
logoImg.src = "image/photo_2024-10-24_19-40-26.jpg";
logoImg.alt = "";
...
let date = new Date();
copyrightPara.textContent = `\u00A9 ${date.getFullYear()} Baraah . All rights reserved`;

const designerSpan = document.createElement("span");
designerSpan.classList.add("designer");
designerSpan.textContent = "Designed By Baraah Adnan";
